...
from overfill.data import DataCollatorForCompletionOnlyLM
...
def main():
    ...
    # Load tokenizer
    ################
    tokenizer = get_tokenizer(model_args.model_name_or_path, model_args, data_args, cache_dir=training_args.model_cache_dir)
    ...
    #     model = get_model(model, model_args, cache_dir=training_args.model_cache_dir)
    ...
    collator = DataCollatorForCompletionOnlyLM(tokenizer, response_template, completion_only=training_args.completion_only)
